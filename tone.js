! function(t, e) {
    ...
    return function(t) {
                ...
                void 0 === (s = function(t) {
                        ...
                        return e.prototype.toString = function() {
                            ...
                            e.prototype._collectDefaults = function(t) {
                                var i = [];
                                if (e.isDefined(t.defaults) && (i = Object.keys(t.defaults)),
                            ...
                            e.defaultArg = function(t, i) {
                                if (e.isObject(t) && e.isObject(i)) {
                                    var n = {};
                                    for (var o in t)
                                        n[o] = e.defaultArg(i[o], t[o]);
                                    for (var s in i)
                                        n[s] = e.defaultArg(t[s], i[s]);
                                    return n
                                }
                    ...
                    return t.Source = function(e) {
                        ...
                        t.Source.prototype.start = function(e, i, n) {
                            if (e = t.isUndef(e) && this._synced ? t.Transport.seconds : this.toSeconds(e),
                                ...
                                this.restart(e, i, n);
                            else if (this._state.setStateAtTime(t.State.Started, e),
                                this._synced) {
                    ...
                    return t.Buffer = function() {
                            ...
                            t.call(this),
                                ...
                                e.url instanceof AudioBuffer || e.url instanceof t.Buffer ? (this.set(e.url),
                                    this.loaded || (this.onload = e.onload)) : t.isString(e.url) && this.load(e.url).then(e.onload).catch(e.onerror)
                        },
                        t.extend(t.Buffer),
                        t.Buffer.defaults = {
                            url: void 0,
                        ...
                        t.Buffer.load = function(e, i, n) {
                            ...
                            function l(e) {
                                if (t.Buffer._removeFromDownloadQueue(u),
                                    t.Buffer.emit("error", e), !n)
                                    throw e;
                                n(e)
                            }
                            ...
                            return u.open("GET", t.Buffer.baseUrl + e, !0),
            ...
            void 0 === (o = function(t) {
                    ...
                    return t.LFO = function() {
                        ...
                        t.LFO.prototype.connect = function(e) {
                            return e.constructor !== t.Signal && e.constructor !== t.Param || (this.convert = e.convert,
                                    this.units = e.units),
                    ...
                    return t.Param = function() {
                        ...
                        t.Param.prototype.getValueAtTime = function(e) {
                            ...
                            if (null === n)
                                ...
                                s = null === i ? n.value : i.type === t.Param.AutomationType.Linear ? this._linearInterpolate(n.time, n.value, i.time, i.value, e) : i.type === t.Param.AutomationType.Exponential ? this._exponentialInterpolate(n.time, n.value, i.time, i.value, e) : n.value;
                            return s
                        },
                        ...
                        t.Param.prototype.cancelAndHoldAtTime = function(e) {
                            ...
                            return n && n.time === e ? o ? this._events.cancel(o.time) : this._events.cancel(e + this.sampleTime) : o && (this._events.cancel(o.time),
                    ...
                    t.Transport = function() {
                        ...
                        t.Transport.prototype.cancel = function(e) {
                            return e = t.defaultArg(e, 0),
                                e = this.toTicks(e),
                                this._timeline.forEachFrom(e, function(t) {
                                        this.clear(t.id)
                                    }
                                    .bind(this)),
                                this._repeatedEvents.forEachFrom(e, function(t) {
                                        this.clear(t.id)
                                    }
                                    .bind(this)),
                                this
                            ...
                            set: function(e) {
                                if (this._clock.ticks !== e) {
                                    ...
                                    this.state === t.State.Started ? (this.emit("stop", i),
                                        ...
                                        this.emit("start", i, this.seconds)) : this._clock.setTicksAtTime(e, i)
                                }
                            }
                        }),
            ...
            void 0 === (o = function(t) {
                    ...
                    return t.Oscillator = function() {
                        ...
                        t.Oscillator.prototype._getRealImaginary = function(e, i) {
                            ...
                            if (e === t.Oscillator.Type.Custom)
                                ...
                                a ? (r = parseInt(a[2]) + 1,
                                        ...
                                        e = a[1],
                                        n = r = Math.max(r, 2)) : this._partialCount = 0,
                                    this._partials = []
                            }
                            for (var l = 1; l < n; ++l) {
                                var h, u = 2 / (l * Math.PI);
                                ...
                                0 !== h ? (o[l] = -h * Math.sin(i * l),
                                    s[l] = h * Math.cos(i * l)) : (o[l] = 0,
                                    s[l] = 0)
                            }
                            return [o, s]
                        },
                        ...
                        t.Oscillator.prototype._getInitialValue = function() {
                            for (var t = this._getRealImaginary(this._type, 0), e = t[0], i = t[1], n = 0, o = 2 * Math.PI, s = 0; s < 8; s++)
        ...
        n = [i(0), i(35), i(24), i(34)],
            void 0 === (o = function(t) {
                    t.Context = function() {
                            ...
                            if (!i.context && (i.context = new t.global.AudioContext, !i.context))
                    ...
                    if (e.Type = {
                            ...
                            function n(i, n, o) {
                                if (i.input)
                                    return o = t.defaultArg(o, 0),
                                        t.isArray(i.input) ? this.connect(i.input[o]) : this.connect(i.input, n, o);
                                try {
                                    return i instanceof AudioNode ? (e.call(this, i, n, o),
                                        i) : (e.call(this, i, n),
                                        i)
                                } catch (t) {
                        ...
                        if (t.global.TONE_AUDIO_CONTEXT || (t.global.TONE_AUDIO_CONTEXT = new t.Context),
                            t.context = t.global.TONE_AUDIO_CONTEXT, !t.global.TONE_SILENCE_VERSION_LOGGING) {
                            var i = "v";
                            "dev" === t.version && (i = "");
                    ...
                    return t.Timeline = function() {
                        ...
                        t.Timeline.prototype.forEachBetween = function(t, e, i) {
                            var n = this._search(t),
                                o = this._search(e);
                            return -1 !== n && -1 !== o ? (this._timeline[n].time !== t && (n += 1),
                                    this._timeline[o].time === e && (o -= 1),
                                    this._iterate(i, n, o)) : -1 === n && this._iterate(i, 0, o),
                                this
                        },
            ...
            void 0 === (o = function(t) {
                    return t.BufferSource = function() {
                        ...
                        t.BufferSource.prototype.start = function(e, i, n, o) {
                            ...
                            if (s > 0 ? (this._gainNode.gain.setValueAtTime(0, e),
                                    "linear" === this.curve ? this._gainNode.gain.linearRampToValueAtTime(o, e + s) : this._gainNode.gain.exponentialApproachValueAtTime(o, e, s)) : this._gainNode.gain.setValueAtTime(o, e),
                                this._startTime = e,
                                t.isDefined(n)) {
                            ...
                            return this._source.buffer = this.buffer.get(),
                                ...
                                i < this.buffer.duration && (this._sourceStarted = !0,
                        ...
                        t.BufferSource.prototype.stop = function(e) {
                            this.log("stop", e),
                                this.assert(this.buffer.loaded, "buffer is either not set or not loaded"),
                                this.assert(!this._sourceStopped, "source is already stopped"),
                                e = this.toSeconds(e), -1 !== this._stopTime && this.cancelStop();
                            var i = this.toSeconds(this.fadeOut);
                            return this._stopTime = e + i,
                                i > 0 ? "linear" === this.curve ? this._gainNode.gain.linearRampTo(0, i, e) : this._gainNode.gain.targetRampTo(0, i, e) : (this._gainNode.gain.cancelAndHoldAtTime(e),
                        ...
                        t.Emitter.prototype.emit = function(t) {
                            if (this._events) {
                                ...
                                if (this._events.hasOwnProperty(t))
                                    for (var i = this._events[t].slice(0), n = 0, o = i.length; n < o; n++)
                                        i[n].apply(this, e)
                            }
                            return this
                        },
            ...
            void 0 === (o = function(t) {
                    ...
                    t.OmniOscillator.prototype._start = function(t) {
                        ...
                        Object.defineProperty(t.OmniOscillator.prototype, "type", {
                            get: function() {
                                var t = "";
                                return this._sourceType === o ? t = "fm" : this._sourceType === s ? t = "am" : this._sourceType === r && (t = "fat"),
                                    t + this._oscillator.type
                            },
                            set: function(t) {
                                "fm" === t.substr(0, 2) ? (this._createNewOscillator(o),
                                    this._oscillator.type = t.substr(2)) : "am" === t.substr(0, 2) ? (this._createNewOscillator(s),
                                    this._oscillator.type = t.substr(2)) : "fat" === t.substr(0, 3) ? (this._createNewOscillator(r),
                                    this._oscillator.type = t.substr(3)) : "pwm" === t ? this._createNewOscillator(i) : "pulse" === t ? this._createNewOscillator(e) : (this._createNewOscillator(n),
                                    this._oscillator.type = t)
                            }
                        }),
                    ...
                    return Object.defineProperty(t.OmniOscillator.prototype, "sourceType", {
                            ...
                            set: function(t) {
                                ...
                                "pwm" !== this._oscillator.type && "pulse" !== this._oscillator.type && (e = this._oscillator.type),
                                    t === a.FMOscillator ? this.type = "fm" + e : t === a.AMOscillator ? this.type = "am" + e : t === a.FatOscillator ? this.type = "fat" + e : t === a.Oscillator ? this.type = e : t === a.PulseOscillator ? this.type = "pulse" : t === a.PWMOscillator && (this.type = "pwm")
                            }
                        }),
                        ...
                        t.Envelope.prototype.triggerAttack = function(e, i) {
                            ...
                            if (o) {
                                var l = i * this.sustain,
                                    h = e + n;
                                this.log("decay", h),
                                    "linear" === this._decayCurve ? this._sig.linearRampTo(l, o, h + this.sampleTime) : "exponential" === this._decayCurve && this._sig.exponentialApproachValueAtTime(l, h, o)
                            }
                            return this
                        },
                        t.Envelope.prototype.triggerRelease = function(e) {
                            ...
                            if (i > 0) {
                                ...
                                if ("linear" === this._releaseCurve)
                                    ...
                                    t.isArray(o) && (this._sig.cancelAndHoldAtTime(e),
                                ...
                                this._state.forEachFrom(e, function(e) {
                                        ...
                                        if (e.state === t.State.Started) {
                                            ...
                                            if (this._loop) {
                                                ...
                                                e.id = t.Transport.schedule(this._tick.bind(this), t.Ticks(n))
                                        }
                                    }
                                    .bind(this)),
                                this
        ...
        n = [i(0), i(45)],
            void 0 === (o = function(t) {
                    return t.Ticks = function(e, i) {
                            if (!(this instanceof t.Ticks))
                                return new t.Ticks(e, i);
                    ...
                    return t.TickSource = function() {
                        ...
                        t.TickSource.prototype.stop = function(e) {
                            if (e = this.toSeconds(e),
                                ...
                                i.time > 0 && (this._tickOffset.cancel(i.time),
                    ...
                    return t.Time = function(e, i) {
                        ...
                        t.Time.prototype.toBarsBeatsSixteenths = function() {
                            ...
                            return e = Math.floor(e) % this._getTimeSignature(),
                                (n = n.toString()).length > 3 && (n = parseFloat(parseFloat(n).toFixed(3))), [i, e, n].join(":")
                        },
        ...
        n = [i(0), i(11), i(6), i(56), i(31)],
            void 0 === (o = function(t) {
                    ...
                    return t.Player = function(e) {
                            var i;
                            e instanceof t.Buffer && e.loaded ? (e = e.get(),
                    ...
                    return t.Part = function() {
                        ...
                        t.Part.prototype._startNote = function(e, i, n) {
                            i -= n,
                                this._loop ? e.startOffset >= this._loopStart && e.startOffset < this._loopEnd ? (e.startOffset < n && (i += this._getLoopDuration()),
                                    e.start(t.Ticks(i))) : e.startOffset < this._loopStart && e.startOffset >= n && (e.loop = !1,
                                    e.start(t.Ticks(i))) : e.startOffset >= n && e.start(t.Ticks(i))
                        },
                        ...
                        t.Part.prototype.at = function(e, i) {
                            ...
                            for (var n = t.Ticks(1).toSeconds(), o = 0; o < this._events.length; o++) {
                                ...
                                if (Math.abs(e.toTicks() - s.startOffset) < n)
                                    return t.isDefined(i) && (s.value = i),
                                        s
                            }
                            return t.isDefined(i) ? (this.add(e, i),
                        ...
                        t.Part.prototype.remove = function(e, i) {
                            ...
                            for (var n = this._events.length - 1; n >= 0; n--) {
                                ...
                                o.startOffset === e && (t.isUndef(i) || t.isDefined(i) && o.value === i) && (this._events.splice(n, 1),
                                    o.dispose())
                            }
                            return this
                        },
            ...
            void 0 === (o = function(t) {
                    ...
                    return t.Convolver = function() {
                            ...
                            t.Effect.call(this, e),
                                ...
                                this._buffer = new t.Buffer(e.url, function(t) {
                                        this.buffer = t.get(),
                                            e.onload()
                                    }
                                    .bind(this)),
                    ...
                    return t.CtrlPattern = function() {
                        ...
                        t.CtrlPattern.prototype.next = function() {
                            ...
                            return e === t.CtrlPattern.Type.Up ? (this.index++,
                                    this.index >= this.values.length && (this.index = 0)) : e === t.CtrlPattern.Type.Down ? (this.index--,
                                    this.index < 0 && (this.index = this.values.length - 1)) : e === t.CtrlPattern.Type.UpDown || e === t.CtrlPattern.Type.DownUp ? (this._direction === t.CtrlPattern.Type.Up ? this.index++ : this.index--,
                                    ...
                                    this.index = Math.min(this.index, this.values.length - 1)) : e === t.CtrlPattern.Type.RandomOnce ? (this.index++,
            ...
            void 0 === (o = function(t) {
                    return t.TransportRepeatEvent = function(e, i) {
                        ...
                        t.TransportRepeatEvent.prototype._createEvents = function(e) {
                            ...
                            i >= this.time && i >= this._nextTick && this._nextTick + this._interval < this.time + this.duration && (this._nextTick += this._interval,
                    ...
                    return t.Clock = function() {
                        ...
                        t.Clock.prototype._loop = function() {
                            var e = this._lastUpdate,
                                i = this.now();
                            this._lastUpdate = i,
                                e !== i && (this._state.forEachBetween(e, i, function(e) {
                                            switch (e.state) {
                                        ...
                                        .bind(this)),
                                    this._tickSource.forEachTickBetween(e, i, function(t, e) {
                                            this.callback(t, e)
                                        }
                                        .bind(this)))
                        },
        ...
        n = [i(0), i(34), i(63), i(20), i(3)],
            void 0 === (o = function(t) {
                    if (t.supported && !t.global.AudioContext.prototype.createConstantSource) {
                        var e = function(t) {
                            this.context = t;
                            for (var e = t.createBuffer(1, 128, t.sampleRate), i = e.getChannelData(0), n = 0; n < i.length; n++)
                                i[n] = 1;
        ...
        n = [i(0), i(46)],
            void 0 === (o = function(t) {
                    return t.Midi = function(e, i) {
                            if (!(this instanceof t.Midi))
                                return new t.Midi(e, i);
        ...
        n = [i(0)],
            void 0 === (o = function(t) {
                    t.supported && (OscillatorNode.prototype.setPeriodicWave || (OscillatorNode.prototype.setPeriodicWave = OscillatorNode.prototype.setWaveTable),
                    ...
                    return t.PolySynth = function() {
                        ...
                        t.PolySynth.prototype._getClosestVoice = function(e, i) {
                            var n = this.voices.find(function(n) {
                                if (Math.abs(n.frequency.getValueAtTime(e) - t.Frequency(i)) < 1e-4 && n.getLevelAtTime(e) > 1e-5)
                                    return n
                            });
            ...
            void 0 === (o = function(t) {
                    ...
                    return t.Freeverb = function() {
                            ...
                            for (var l = 0; l < e.length; l++) {
                                ...
                                l < e.length / 2 ? this.effectSendL.chain(h, this._allpassFiltersL[0]) : this.effectSendR.chain(h, this._allpassFiltersR[0]),
                    ...
                    t.Listener = function() {
                        ...
                        t.Listener.prototype.setOrientation = function(t, e, i, n, o, s) {
                            if (this.context.rawContext.listener.forwardX) {
                                ...
                                this.context.rawContext.listener.setOrientation(t, e, i, n, o, s);
                    ...
                    return t.CtrlMarkov = function(e, i) {
                        ...
                        t.CtrlMarkov.prototype._getProbDistribution = function(e) {
                            for (var i = [], n = 0, o = !1, s = 0; s < e.length; s++) {
                                var r = e[s];
                                t.isObject(r) ? (o = !0,
                                        i[s] = r.probability) : i[s] = 1 / e.length,
                                    n += i[s]
                            }
                            if (o)
